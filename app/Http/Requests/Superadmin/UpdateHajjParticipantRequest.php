...
class UpdateHajjParticipantRequest extends FormRequest
{
    ...
    {
        $participant = $this->route('hajj_participant');
        ...
        return [
            ...
            'nomor_porsi' => [
                ...
                'string',
                'max:20',
                Rule::unique('hajj_participants')
                    ->where(fn ($q) => $q->where('tahun_haji', $this->integer('tahun_haji')))
