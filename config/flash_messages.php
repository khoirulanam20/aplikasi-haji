...
return [
    ...
    'group-created' => [
        'type' => 'success',
        'title' => 'Berhasil',
        'message' => 'Grup modul berhasil ditambahkan.',
    ],
    'group-updated' => [
        'type' => 'success',
        'title' => 'Berhasil',
        'message' => 'Grup modul berhasil diperbarui.',
    ],
    'group-deleted' => [
        'type' => 'success',
        'title' => 'Berhasil',
        'message' => 'Grup modul berhasil dihapus.',
    ],
    'module-created' => [
        'type' => 'success',
        'title' => 'Berhasil',
    ...
    'imported' => [
        ...
        'message' => 'Proses import Excel telah selesai.',
    ],
    'impersonation-started' => [
        'type' => 'warning',
        'title' => 'Impersonate',
        'message' => 'Anda sekarang masuk sebagai pengguna lain.',
    ],
